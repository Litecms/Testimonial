...
class RouteServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        if (Request::is('*/testimonial/testimonial/*')) {
            Route::bind('testimonial', function ($testimonial) {
                $testimonialrepo = $this->app->make('Litecms\Testimonial\Interfaces\TestimonialRepositoryInterface');
                return $testimonialrepo->findorNew($testimonial);
            });
        }
