<div class="btn-group testimonial-testimonial">
...
$(document).ready(function(){
    ...
    $(".testimonial-testimonial .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/testimonial.testimonial.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".testimonial-testimonial .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.testimonial-testimonial .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'testimonial.testimonial.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#testimonial-testimonial-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#testimonial-testimonial-list .btn-reset-filter').css('display', 'none');
